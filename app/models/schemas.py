...
class IdentityProfile(BaseModel):
    age: int = Field(..., ge=0)
    nationality_zone: str = Field(..., description="FR / UE / OTHER")
...
class UserProfile(BaseModel):
    ...
    current_status: str = Field(..., description="salaried / independent / student / apprentice / trainee / partial_unemployment")
